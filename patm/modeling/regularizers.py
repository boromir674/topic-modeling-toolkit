...
class RegularizersFactory(object):
    regs_mapping = {
        'sparse-phi-specific': 'smooth-sparse-phi',
        'smooth-phi-background': 'smooth-sparse-phi',
        'sparse-theta-specific': 'smooth-sparse-theta',
        'smooth-theta-background': 'smooth-sparse-phi',
        'decorrelate-specific': 'decorrelator-phi'
    }
...
regularizer_class_string2reg_type = {constructor.__name__: reg_type for reg_type, constructor in RegularizersFactory.reg_type2constructor.items()}
