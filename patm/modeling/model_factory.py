...
class ModelFactory(object):
    ...
    def create_model_with_phi_from_disk(self, phi_file_path, results):
        ...
        for score_setting_name, eval_instance_name in results['_eval_name2eval_type'].items():
            model.scores.add(self._eval_factory.create_artm_scorer(score_setting_name, eval_instance_name))
