...
def get_cl_arguments():
    ...
    parser.add_argument('--models', dest='model_labels', nargs='*', help='the models to compare by plotting graphs')
...
if __name__ == '__main__':
    ...
    graph_maker.build_graphs_from_collection(args.collection, 8,
                                             metric='perplexity',
                                             score_definitions=metrics,
                                             tau_trajectories=args.plot_trajectories_flag)