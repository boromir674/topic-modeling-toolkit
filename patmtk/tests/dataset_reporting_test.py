...
class TestDatasetReporter(object):
    ...
    def test_simple_strings(self, dataset_reporter):
        ...
        assert '\n'.join(strings_list1) == 'unittest-dataset/100_lowercase_monospace_unicode_deaccent_normalize-lemmatize_minlength-2_maxlength-25_ngrams-1_nobelow-1_noabove-0.5_weight-counts_format1-uci.format2-vowpal.pkl'
